...
Register                      Login
  ...
  |-----------------------------|
        ...
        |                   |
        v                   v
  JOB SEEKER MENU     RECRUITER MENU
        |                   |
        |                   |
   1. View Jobs        1. Post Job
   2. Search Job       2. View Jobs
   3. Apply Job        3. View Applicants
   4. Update Resume    4. Rank Resumes (TF-IDF)
   5. Logout           5. Logout

### 📌 TF-IDF Ranking Flow
Recruiter selects Job ID
          |
          v
Fetch all applicants for that job
          |
          v
Collect all resumes
          |
...
For each required skill
          ...
          |------------------------------|
          v                              v
Calculate DF                   For each applicant
(# of resumes containing skill)        |
                                       v
                              Calculate TF
                              (frequency in resume)
                                       |
